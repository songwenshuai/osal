...
#define  USER_LD1_GPIOB_PIN             GPIO_PIN_5
#define  USER_LD2_GPIOB_PIN             GPIO_PIN_0
#define  USER_LD3_GPIOB_PIN             GPIO_PIN_1
...
void  BSP_LED_Init (void)
{
    ...
    gpio_init.Pin   = USER_LD2_GPIOB_PIN;
    HAL_GPIO_Init(USER_LED2_GPIO_PORT, &gpio_init);

    gpio_init.Pin   = USER_LD3_GPIOB_PIN;
...
void  BSP_LED_On (BSP_LED  led)
{
    switch (led) {
        case USER_LED_ALL:
             ...
             HAL_GPIO_WritePin(USER_LED2_GPIO_PORT, USER_LD2_GPIOB_PIN, GPIO_PIN_SET);
             HAL_GPIO_WritePin(USER_LED3_GPIO_PORT, USER_LD3_GPIOB_PIN, GPIO_PIN_SET);
             break;
...
void  BSP_LED_Off (BSP_LED  led)
{
    switch (led) {
        case USER_LED_ALL:
             ...
             HAL_GPIO_WritePin(USER_LED2_GPIO_PORT, USER_LD2_GPIOB_PIN, GPIO_PIN_RESET);
             HAL_GPIO_WritePin(USER_LED3_GPIO_PORT, USER_LD3_GPIOB_PIN, GPIO_PIN_RESET);
             break;
...
uint32_t  BSP_LED_Read (BSP_LED  led)
{
    ...
    switch (led) {
        case USER_LED_ALL:
             ...
             LedState |= HAL_GPIO_ReadPin(USER_LED2_GPIO_PORT, USER_LD2_GPIOB_PIN) << 1;
             LedState |= HAL_GPIO_ReadPin(USER_LED3_GPIO_PORT, USER_LD3_GPIOB_PIN) << 2;
             break;
        ...
        case USER_LD2:
             LedState =  HAL_GPIO_ReadPin(USER_LED2_GPIO_PORT, USER_LD2_GPIOB_PIN);
             break;


        case USER_LD3:
             LedState =  HAL_GPIO_ReadPin(USER_LED3_GPIO_PORT, USER_LD3_GPIOB_PIN);
             break;
...
void  BSP_LED_Toggle (BSP_LED  led)
{
    switch (led) {
        case USER_LED_ALL:
             ...
             HAL_GPIO_TogglePin(USER_LED2_GPIO_PORT, USER_LD2_GPIOB_PIN);
             HAL_GPIO_TogglePin(USER_LED3_GPIO_PORT, USER_LD3_GPIOB_PIN);
             break;
